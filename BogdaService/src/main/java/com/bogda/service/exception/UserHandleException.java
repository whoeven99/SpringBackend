...
public class UserHandleException {
    ...
    public BaseResponse resolveException(Exception ex) {
        ...
        if (ex instanceof ClientException) {
            ...
            TraceReporterHolder.report("UserHandleException.BaseResponse", "AppException failed by " + ((ClientException) ex).getErrorMessage());
        ...
        TraceReporterHolder.report("UserHandleException.BaseResponse", "Exception failed by " + ex.getMessage() + "\n" + stack);
    ...
    public BaseResponse handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        TraceReporterHolder.report("UserHandleException.handleMethodArgumentNotValidException", "Valid参数错误信息: " + message);
