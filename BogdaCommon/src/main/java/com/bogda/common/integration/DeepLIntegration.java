        ...
        try {
            ...
            result = TimeOutUtils.callWithTimeoutAndRetry(() -> {
                        try {
                            ...
                            CaseSensitiveUtils.appInsights.trackTrace("每日须看 translateByDeepL deepL翻译报错信息 errors ： " + e.getMessage() + " translateText : " + sourceText + " 用户：" + shopName);
            ...
            CaseSensitiveUtils.appInsights.trackTrace("result: " + result);
            ...
            CaseSensitiveUtils.appInsights.trackTrace("clickTranslation translateByDeepL 用户： " + shopName + "翻译的文本： " + sourceText + " token deepL : " + targetText + " all: " + totalToken);
            if (isSingleFlag) {
            ...
            CaseSensitiveUtils.appInsights.trackTrace("clickTranslation translateByDeepL deepL翻译报错信息 errors : " + e + " sourceText: " + sourceText + " targetCode: " + targetCode);
            CaseSensitiveUtils.appInsights.trackException(e);
        }
        return sourceText;
    }
