    ...
    public static Map<String, Object> getCurrencyDOS(CurrenciesDO currenciesDO) {
        ...
        try {
            ...
            if (currencyInfo != null) {
                ...
                map.put("symbol", "-");
                CaseSensitiveUtils.appInsights.trackTrace("符号错误 ： " + currenciesDO.getShopName());
            }

        } catch (NoSuchFieldException | IllegalAccessException e) {
            CaseSensitiveUtils.appInsights.trackTrace(currenciesDO.getCurrencyCode() + "currency error :  " + e.getMessage());
            CaseSensitiveUtils.appInsights.trackTrace(" currency error :  " + e.getMessage());
        }
        return map;
    }
}
