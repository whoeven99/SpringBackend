...
public class AliyunLogSqlUtils {
    // getProductExposureUvByShopName - 查询产品根据shopName，多少天内，曝光的uv数
    ...
    // getProductExposurePvByShopName - 查询产品根据shopName，曝光的pv数
    public static String getProductExposurePvByShopName(String shopName) {
        return "event: \"product_viewed\" AND shopName:\"" + shopName +
                "\" | SELECT count(*) as pv";
    }

    // getProductAddedToCartPvByShopName - 查询产品根据shopName，加购的pv数
