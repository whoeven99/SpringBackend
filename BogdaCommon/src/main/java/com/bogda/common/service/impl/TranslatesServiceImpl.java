...
import com.bogda.common.mapper.TranslatesMapper;
import com.bogda.common.model.controller.request.AutoTranslateRequest;
        ...
        while (attempt < maxRetries) {
            ...
            try {
                ...
                if (attempt >= maxRetries) {
                    CaseSensitiveUtils.appInsights.trackTrace("updateStatus3To6: " + shopName + " 最终失败");
                }
            }
        }
        return false;
