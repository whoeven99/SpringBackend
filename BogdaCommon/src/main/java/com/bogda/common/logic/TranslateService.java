...
import com.bogda.common.integration.TranslateApiIntegration;
...
//         v2, 后面的以后删掉
        ...
        CaseSensitiveUtils.appInsights.trackTrace("stopTranslationManually 用户 " + shopName + " 的翻译标识存储成功");
    ...
    public void syncShopifyAndDatabase(String shopName, String accessToken, String source) {
        ...
        try {
            ...
            CaseSensitiveUtils.appInsights.trackTrace("syncShopifyAndDatabase Failed to get Shopify data errors : " + e.getMessage());
            return;
        }
    ...
    public String imageTranslate(String sourceCode, String targetCode, String imageUrl, String shopName, String accessToken) {
        CaseSensitiveUtils.appInsights.trackTrace("imageTranslate 用户 " + shopName + " sourceCode " + sourceCode + " targetCode " + targetCode + " imageUrl " + imageUrl + " accessToken " + accessToken);
