...
public class TencentEmailService {
    ...
    public boolean sendAutoTranslateEmail(String shopName, List<InitialTaskV2DO> shopTasks) {
        ...
        return emailIntegration.sendEmailByTencent(140352L, MailChimpConstants.SUCCESSFUL_AUTO_TRANSLATION_SUBJECT, templateData, MailChimpConstants.TENCENT_FROM_EMAIL, usersDO.getEmail());
    }
    ...
    public boolean sendSuccessEmail(String shopName, String target, Integer translateTime, Integer usedTokenByTask, Integer usedToken, Integer totalToken) {
        ...
        return emailIntegration.sendEmailByTencent(137353L, MailChimpConstants.SUCCESSFUL_TRANSLATION_SUBJECT, templateData, MailChimpConstants.TENCENT_FROM_EMAIL, usersDO.getEmail());
    }
    ...
    public boolean sendFailedEmail(String shopName, String target, Integer translateTime, Integer usedTokenByTask, String translatedModules, String unTranslatedModules) {
        ...
        return emailIntegration.sendEmailByTencent(137317L, MailChimpConstants.TRANSLATION_FAILED_SUBJECT, templateData, MailChimpConstants.TENCENT_FROM_EMAIL, usersDO.getEmail());
    }
...
//        appInsights.trackTrace("templateData" + templateData);
        //由腾讯发送邮件
        Boolean b = emailIntegration.sendEmailByTencent(new TencentSendEmailRequest(143058L, templateData, MailChimpConstants.SUBSCRIBE_SUCCESSFUL_SUBJECT, MailChimpConstants.TENCENT_FROM_EMAIL, usersDO.getEmail()));
        //存入数据库中
        emailService.saveEmail(new EmailDO(0, shopName, MailChimpConstants.TENCENT_FROM_EMAIL, usersDO.getEmail(), MailChimpConstants.SUBSCRIBE_SUCCESSFUL_SUBJECT, b ? 1 : 0));
    }
    ...
    public void sendApgInitEmail(String email, Long userId) {
        //由腾讯发送邮件
        Boolean b = emailIntegration.sendEmailByTencent(new TencentSendEmailRequest(144208L, null, MailChimpConstants.APG_INIT_EMAIL, MailChimpConstants.TENCENT_FROM_EMAIL, email));
        //存入数据库中
        iapgEmailService.saveEmail(new APGEmailDO(null, userId, MailChimpConstants.TENCENT_FROM_EMAIL, email, MailChimpConstants.APG_INIT_EMAIL, b));
    }
    ...
    public void sendAPGSuccessEmail(String email, Long userId, String taskType, String userName, Timestamp createTime, Integer totalToken, Integer products, Integer remaining) {
        ...
        //设置参数
        Boolean b = emailIntegration.sendEmailByTencent(new TencentSendEmailRequest(144209L, templateData, MailChimpConstants.APG_GENERATE_SUCCESS, MailChimpConstants.TENCENT_FROM_EMAIL, email));
        //存入数据库中
        iapgEmailService.saveEmail(new APGEmailDO(null, userId, MailChimpConstants.TENCENT_FROM_EMAIL, email, MailChimpConstants.APG_GENERATE_SUCCESS, b));
    }
    ...
    public Integer sendAPGPurchaseEmail(APGUsersDO apgUsersDO, Integer numberOfCredits, Double creditAmount, Integer creditBalance) {
        ...
        //由腾讯发送邮件
        Boolean b = emailIntegration.sendEmailByTencent(new TencentSendEmailRequest(144922L, templateData, MailChimpConstants.APG_PURCHASE_EMAIL, MailChimpConstants.TENCENT_FROM_EMAIL, apgUsersDO.getEmail()));
        //存入数据库中
        return iapgEmailService.saveEmail(new APGEmailDO(null, apgUsersDO.getId(), MailChimpConstants.TENCENT_FROM_EMAIL, apgUsersDO.getEmail(), MailChimpConstants.APG_PURCHASE_EMAIL, b)) ? 1 : 0;
    }
    ...
    public void sendAPGTaskInterruptEmail(APGUsersDO apgUsersDO, Integer completedCount, Integer remainingCount, Integer creditBalance) {
        ...
        //由腾讯发送邮件
        Boolean b = emailIntegration.sendEmailByTencent(new TencentSendEmailRequest(144923L, templateData, MailChimpConstants.APG_TASK_INTERRUPT_EMAIL, MailChimpConstants.TENCENT_FROM_EMAIL, apgUsersDO.getEmail()));
        //存入数据库中
        iapgEmailService.saveEmail(new APGEmailDO(null, apgUsersDO.getId(), MailChimpConstants.TENCENT_FROM_EMAIL, apgUsersDO.getEmail(), MailChimpConstants.APG_TASK_INTERRUPT_EMAIL, b));
    }
    ...
    public void sendIpReportEmail(String shopName, int noCurrencyCount, int noLanguageCount,
        ...
        if (user == null) {
            CaseSensitiveUtils.appInsights.trackTrace("FatalException sendIpReportEmail user is null " + shopName);
            return;
        }
        ...
        CaseSensitiveUtils.appInsights.trackTrace("sendIpReportEmail " + shopName + " 邮件发送结果为： " + result);
    }
    ...
    public void sendThemeEmail(String shopName) {
        ...
        Boolean flag = emailIntegration.sendEmailByTencent(new TencentSendEmailRequest(159294L,
                templateData, MailChimpConstants.USER_THEME_EMAIL, MailChimpConstants.TENCENT_FROM_EMAIL, "feynman@ciwi.ai"));
        emailService.saveEmail(new EmailDO(0, shopName, MailChimpConstants.TENCENT_FROM_EMAIL, usersDO.getEmail(), MailChimpConstants.USER_THEME_EMAIL, flag ? 1 : 0));
    }
    ...
    public void sendDefaultLanguageEmail(String shopName) {
        ...
        Boolean flag = emailIntegration.sendEmailByTencent(new TencentSendEmailRequest(159295L,
                templateData, MailChimpConstants.USER_LANGUAGE_EMAIL, MailChimpConstants.TENCENT_FROM_EMAIL, "feynman@ciwi.ai"));
        emailService.saveEmail(new EmailDO(0, shopName, MailChimpConstants.TENCENT_FROM_EMAIL, usersDO.getEmail(), MailChimpConstants.USER_LANGUAGE_EMAIL, flag ? 1 : 0));
    }
    ...
    public void sendThemeSwitchEmail(String shopName) {
        ...
        emailService.saveEmail(new EmailDO(0, shopName, MailChimpConstants.TENCENT_FROM_EMAIL, usersDO.getEmail(), MailChimpConstants.USER_SWITCH_EMAIL, flag ? 1 : 0));
    }
}
