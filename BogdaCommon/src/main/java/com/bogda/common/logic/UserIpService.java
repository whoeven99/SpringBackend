...
import com.bogda.common.repository.repo.UserIPCountRepo;
import com.bogda.common.repository.repo.UserIPRedirectionRepo;
...
public class UserIpService {
    ...
    public Boolean checkUserIp(String shopName) {
        ...
        CaseSensitiveUtils.appInsights.trackTrace("checkUserIp userIpDO = " + userIpDO);
...
//                userIpDO.setTimes(currentTimes + 1);
    ...
    public BaseResponse<Object> noCrawlerPrintLog(String shopName, NoCrawlerVO noCrawlerVO) {
        CaseSensitiveUtils.appInsights.trackTrace("状态码：" + noCrawlerVO.getStatus() + " , " + shopName + " 客户ip定位： " + noCrawlerVO.getUserIp()
    ...
    public BaseResponse<Object> includeCrawlerPrintLog(String shopName, IncludeCrawlerVO includeCrawlerVO) {
        CaseSensitiveUtils.appInsights.trackTrace(shopName + " " + includeCrawlerVO.getUaInformation() + " 原因 " + includeCrawlerVO.getUaReason());
        return new BaseResponse<>().CreateSuccessResponse(true);
    }
