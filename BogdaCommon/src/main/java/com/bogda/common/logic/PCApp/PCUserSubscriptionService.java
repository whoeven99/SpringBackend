...
import com.bogda.common.repository.entity.PCSubscriptionsDO;
import com.bogda.common.repository.entity.PCUserSubscriptionsDO;
...
public class PCUserSubscriptionService {
    ...
    public BaseResponse<Object> getUserSubscriptionPlan(String shopName) {
        ...
        // 判断计划名称
        String parsePlanType = StringUtils.parsePlanName(pcSubscriptionByShopName.getPlanName());
        ...
        // 根据新的集合获取这个订阅计划的信息
        String query = ShopifyRequestBody.getSubscriptionQuery(latestActiveSubscribeId);
