...
CREATE NONCLUSTERED INDEX IX_InitialTask_Target_Deleted_CreatedAt_DESC
    ON dbo.Translate_Tasks_V2 (initial_task_id, has_target_value, is_deleted, created_at DESC);

CREATE NONCLUSTERED INDEX IX_InitTask_Resource_Target_Shopify_Deleted
    ON dbo.Translate_Tasks_V2 (initial_task_id, resource_id, has_target_value, saved_to_shopify, is_deleted);
