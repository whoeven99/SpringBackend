...
public class CharsOrdersController {
    ...
    public BaseResponse<Object> insertOrUpdateOrder(@Valid @RequestBody CharsOrdersDO charsOrdersDO) {
    ...
    public BaseResponse<Object> sendPurchaseSuccessEmail(@Valid @RequestBody PurchaseSuccessRequest purchaseSuccessRequest) {
    ...
    public BaseResponse<Object> sendSubscribeSuccessEmail(@RequestParam @NotBlank(message = "店铺名不能为空") String shopName, @Valid @RequestBody TranslationCharsVO translationCharsVO) {
    ...
    public BaseResponse<Object> getLatestActiveSubscribeId(@RequestParam @NotBlank(message = "店铺名不能为空") String shopName) {
