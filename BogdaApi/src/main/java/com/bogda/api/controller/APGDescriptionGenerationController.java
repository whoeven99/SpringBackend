...
public class APGDescriptionGenerationController {
    ...
    public BaseResponse<Object> generateDescription(@RequestParam String shopName, @RequestBody GenerateDescriptionVO generateDescriptionVO) {
        ...
        try {
            ...
            CaseSensitiveUtils.appInsights.trackTrace("generateDescription" + shopName + " generateDescription: " + description);
            if (description == null) {
                return new BaseResponse<>().CreateErrorResponse(false);
            }
        } catch (ClientException e) {
            CaseSensitiveUtils.appInsights.trackTrace("generateDescription shopName : " + shopName + " generateDescription errors : " + e.getMessage());
