...
import com.bogdatech.utils.UserInitialUtils;
...
public class UserService {
    ...
    public BaseResponse<Object> userInitialization(String shopName, UserInitialVO userInitialVO) {
        ...
        // 判断主题数据，然后判断原语言数据
        Map<String, String> themeData = UserInitialUtils.getThemeData(userInitialVO.getDefaultThemeData());
        if (themeData == null) {
        ...
        String themeId = themeData.get("themeId");
        ...
        } else if (!themeId.equals(userDefaultTheme)) {
            // 发送主题邮件
...
//            }
        ...
        } else if (!defaultLanguageData.equals(userDefaultLanguage)) {
            // 发送默认语言邮件
