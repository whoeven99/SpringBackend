...
public class LanguageFlagConfig {
    ...
    public static final String[] EO =
            new String[]{"https://ciwi-1327177217.cos.ap-singapore.myqcloud.com/flag/union.jpeg"};
    ...
    public static final String[] FIL =
    ...
    public static final String[] PT_BR =
    ...
    public static final String[] PT_PT =
